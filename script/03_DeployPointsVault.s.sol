...
/**
 * @notice Script to deploy "Points" Vault through the Deployer.
 * @dev Run with: forge script script/03_DeployPointsVault.s.sol --rpc-url <mantra_rpc> --broadcast --verify
 */
